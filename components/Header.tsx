...
import { Shield, User, MapPin, Building2 } from 'lucide-react';
        ...
        <div className="flex items-center gap-6">
          <div className="hidden lg:flex flex-col items-end border-r border-slate-200 pr-6">
            <div className="flex items-center gap-2 text-[#00339a]">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em]">GATE UTAMA LOBBY</span>
            </div>
          ...
          >
            {isSecurity ? <Shield size={18} className="group-hover:rotate-12 transition-transform" /> : <User size={18} />}
            {isSecurity ? 'AKSES PETUGAS' : 'MODE TAMU'}
          </button>
        </div>
      </div>
    </header>
